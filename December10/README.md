...
slowly enough that it takes hours to align them, but have so much momentum that 
they only stay aligned for a second. If you blink at the wrong time, it might be 
...
After 3 seconds, the message appeared briefly: __`HI`__. Of course, your message 
...
much longer than the __`3`__ seconds in the example above.

Impressed by your sub-hour communication capabilities, the Elves are curious: 
__exactly how many seconds would they have needed to wait for that message to 
appear?__
